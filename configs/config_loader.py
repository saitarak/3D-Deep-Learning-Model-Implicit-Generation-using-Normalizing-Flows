...
def config_parser():
    ...
    # Experiment Setup
    parser.add_argument('--config', is_config_file=True, default='/work/ws-tmp/g051382-NDF_task/ndf/configs/shapenet_cars.txt',
                        help='config file path')
    parser.add_argument("--exp_name", type=str, default='shapenet_cars',
    ...
    parser.add_argument("--data_dir", type=str, default='/work/ws-tmp/g051382-NDF_task/ndf/datasets/shapenet/data/02958343',
                        help='input data directory')
    parser.add_argument("--input_data_glob", type=str, default='/*/models/model_normalized.obj',
                        help='glob expression to find raw input files')
    parser.add_argument("--split_file", type=str, default='/work/ws-tmp/g051382-NDF_task/ndf/datasets/shapenet/data/split_shapenet_cars.npz',
                        help='Path to read and write the data split file. Needs to end with ".npz"')

    # Training Data Parameters
    parser.add_argument("--out_resolution", nargs='+', type=int, default=[16,16,16],
                        help='The output resolution we are trying to get from conv layers')
    ...
    parser.add_argument("--latent_dim", type=int, default=497, help='latent dimension of each codebook vector')
    parser.add_argument("--num_codebook_vectors", type=int, default=6192, help='number of codebook vectors')
...
def get_config():
    ...
    cfg.out_resolution = np.array(cfg.out_resolution)
